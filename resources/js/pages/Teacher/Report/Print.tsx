...
type TeacherReportPrintProps = ReportPrintProps & {
    score_ranges?: ScoreRange[];
};

const TeacherReportPrint = ({
    filters,
    summary,
    ...
    return (
        <div style={wrap}>
            ...
            >
                ...
                <ChartBox title="Distribusi Rentang Poin" border={T.border}>
...
export default TeacherReportPrint;
