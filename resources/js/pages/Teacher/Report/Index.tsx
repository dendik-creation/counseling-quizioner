...
const TeacherReportIndex = ({
    ...
    const buildPrintUrl = () => {
        ...
        return `/teacher/reports/print?${params.toString()}`;
    };
    ...
    const rangeSeries = [
        { name: "Pengerjaan", data: score_ranges.map((s) => s.total) },
    ];
    ...
    const areaOptions: ApexOptions = {
        ...
        dataLabels: { enabled: false },
        xaxis: {
            categories: monthly_trend.map((m) => m.month),
        ...
        <AppLayout>
            ...
            <div className="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
                ...
                <ChartCard
                    ...
                    subtitle="Jumlah pengerjaan per kelompok nilai"
                >
...
export default TeacherReportIndex;
