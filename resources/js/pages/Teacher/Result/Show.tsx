...
const TeacherParticipantResultsShow = ({
    title,
    description,
    results,
    participant,
    ...
    const eachResultOption: ApexOptions = {
        ...
        xaxis: { categories: ["Gus", "Ji", "Gang"] },
        yaxis: { title: { text: "Akumulasi Poin" } },
        fill: { opacity: 1, colors: ["#10b981", "#3b82f6", "#f59e42"] },
    ...
    const resultsOption: ApexOptions = {
        ...
        markers: { size: 5, colors: ["#10b981", "#3b82f6", "#f59e42"] },
    };
        ...
        <AppLayout>
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4">
                ...
                <Link
                    ...
                    href={`/teacher/results/part-${participant.id}/quiz-${results[0].questionnaire_id}/print`}
                >
                    <Button
                        variant="outline"
                                            ...
                                            <Card className="py-3">
                                                <CardContent className="px-3">
                                                    <div className="flex justify-between items-start">
                                                        ...
                                                        {/* URL → /teacher/ */}
                                                        <Link
                                                            href={`/teacher/results/part-${item.participant_id}/res-${item.id}`}
                                                        >
...
export default TeacherParticipantResultsShow;
