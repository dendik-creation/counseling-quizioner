...
const TeacherParticipantResultShowAnswer = ({
    title,
    description,
    result,
    available_questions,
        ...
        <AppLayout>
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4">
                ...
                <Link
                    ...
                    href={`/teacher/results/part-${result.participant_id}/res-${result.id}/print`}
                >
                    <Button
                        variant="outline"
                ...
                <Card className="py-3 col-span-3 lg:col-span-1">
                    <CardContent className="px-3">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <h3 className="font-semibold">Info Partisipan</h3>
                        </div>
...
export default TeacherParticipantResultShowAnswer;
