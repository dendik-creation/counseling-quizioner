...
import { ResultPerDay } from "@/types/report";
...
const MgbkReportIndex = ({
    ...
    const buildPrintUrl = () => {
        ...
        return `/mgbk/reports/print?${params.toString()}`;
    };
    ...
    /* 3. Horizontal Bar – Per Institusi (MGBK-specific, replaces top_origins) */
    const hBarOptions: ApexOptions = {
        ...
        xaxis: {
            categories: per_origin.map((o: PerOrigin) => o.name),
    ...
    const hBarSeries = [
        { name: "Pengerjaan", data: per_origin.map((o: PerOrigin) => o.total) },
    ];

    /* 4. Pie – Category Dominance */
    ...
    return (
        <AppLayout>
            ...
            {/* Charts Row 1 — Harian + Per Institusi */}
            <div className="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3">
                ...
                {/* Pengganti top_origins → per_origin milik MGBK */}
                <ChartCard
            ...
            {/* Charts Row 2 — Poin per Kuisioner + Kategori */}
...
export default MgbkReportIndex;
