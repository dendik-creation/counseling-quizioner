                    ...
                    <TableBody>
                        {results.data.map((result, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell>
                                    <Link
                                        href={`/mgbk/results/part-${result.participant.id}/quiz-${result.questionnaire.id}`}
                                    >
...
export default MgbkResultIndex;
