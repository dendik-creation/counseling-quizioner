...
const MgbkParticipantResultsShow = ({
    title,
    description,
    results,
    participant,
        ...
        <AppLayout>
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4">
                ...
                <Link
                    ...
                    href={`/mgbk/results/part-${participant.id}/quiz-${results[0].questionnaire_id}/print`}
                >
                    <Button
                        variant="outline"
                                            ...
                                            <Card className="py-3">
                                                <CardContent className="px-3">
                                                    <div className="flex justify-between items-start">
                                                        ...
                                                        {/* URL diubah ke /mgbk/ */}
                                                        <Link
                                                            href={`/mgbk/results/part-${item.participant_id}/res-${item.id}`}
                                                        >
...
export default MgbkParticipantResultsShow;
